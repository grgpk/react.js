...
function Button({ children, disabled, to, type, onClick }) {
  const base = `text-sm inline-block rounded-full bg-yellow-400 font-semibold uppercase 
  ...
  const styles = {
    ...
    secondary: `text-sm inline-block rounded-full border-2 border-stone-300 font-semibold uppercase 
    tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 
    focus:text-stone-800 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2
